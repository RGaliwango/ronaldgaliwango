...
I attended the Physiologically based pharmacokinetic (PBPK) modelling Workshop - Kampala, Uganda; Application of Physiologically based pharmacokinetic (PBPK) modelling to optimize pharmacotherapy in pregnant and breastfeeding women.
